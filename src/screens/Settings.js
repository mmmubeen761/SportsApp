        ...
        <>
            <View style={styles.container}>
                ...
                <View style={styles.header}>
                    <Text style={{ color: 'black', fontSize: 20, alignSelf: 'center', paddingTop: 20,fontWeight:'bold' }}>SETTINGS
                    </Text>
                    {/* <FontAwesome
                            name="user"
                            color="#fff"
                    ...
                    <View style={styles.settingtext}>
                        ...
                        <TextInput
                            ...
                            autoCapitalize="none"
                        />
                        <Button style={{width:'50%'}} title="SAVE"/>
                    </View>
                </View>
